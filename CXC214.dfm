object FSitLetGrid: TFSitLetGrid
  Left = 49
  Top = 93
  Width = 729
  Height = 500
  ...
  object fcLabel1: TfcLabel
    ...
    Width = 285
    Height = 24
    Caption = 'Situaci'#243'n de Letras por Cobrar'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -19
    Font.Name = 'MS Sans Serif'
  ...
  object dbgMaestro: TwwDBGrid
    ...
    Selected.Strings = (
      'CIAID'#9'2'#9'C'#237'a'
      'CCANOMES'#9'7'#9'Periodo~Ano-Mes'
      'TDIARID'#9'6'#9'Tipo de~Diario'
      'CCNOREG'#9'8'#9'No.Reg.'
      'DOCID'#9'3'#9'Tipo~Doc.'
      'CCSERIE'#9'7'#9'Serie'
      'CCNODOC'#9'20'#9'No.Documento'
      'TMONID'#9'6'#9'Tipo de~Moneda'
      'CCESTADO'#9'9'#9'Estado'
      'CC_CONTA'#9'7'#9'Conta-~bilizado'
    ...
    OnEnter = dbgMaestroEnter
    object Z2btnAdiciona: TwwIButton
      Left = 0
      Top = 0
      Width = 30
      Height = 30
  ...
  object pnlFiltros: TPanel
    ...
    Color = clTeal
    TabOrder = 1
    object Z2sbBorraFiltro: TSpeedButton
      Left = 136
      Top = 5
      Width = 60
      Height = 19
      ...
      ShowHint = True
      OnClick = Z2sbBorraFiltroClick
    end
    object Z2sbBorraOrden: TSpeedButton
      Left = 274
      Top = 4
      Width = 60
      Height = 20
      ...
      ParentShowHint = False
      ShowHint = True
      OnClick = Z2sbBorraOrdenClick
    end
    object Z2sbOrdena: TSpeedButton
      Left = 338
      Top = 4
      Width = 69
      Height = 20
    ...
    object Z2sbFiltra: TSpeedButton
      Left = 197
      Top = 4
      Width = 69
      Height = 20
    ...
    object lbFiltro: TListBox
      ...
      OnEndDrag = lbFiltroEndDrag
      OnMouseDown = lbFiltroMouseDown
    end
    object lbOrden: TListBox
      ...
      OnEndDrag = lbOrdenEndDrag
      OnMouseDown = lbOrdenMouseDown
    end
    object Z2bbtnImprime: TBitBtn
      ...
      Width = 100
      Height = 41
      Hint = 'Imprime filtro seleccionado'
      Caption = 'Imprime'
      ParentShowHint = False
      ShowHint = True
      TabOrder = 3
    ...
    object Z2bbtnTacho: TBitBtn
      Left = 567
      Top = 58
      Width = 84
      Height = 78
      TabOrder = 4
      OnDragOver = Z2bbtnTachoDragOver
      Glyph.Data = {
    ...
    object Z2bbtnSacaFiltros: TBitBtn
      Left = 736
      Top = 8
      Width = 25
      Height = 25
      ...
      ParentFont = False
      TabOrder = 5
      OnClick = Z2bbtnSacaFiltrosClick
    end
  ...
  object pnlBuscaReg: TPanel
    ...
    object isBuscaReg: TwwIncrementalSearch
      Left = 104
      Top = 32
      Width = 193
      Height = 21
      SearchField = 'TrabId'
      TabOrder = 1
      OnKeyPress = isBuscaRegKeyPress
    end
  end
  object pnlBuscaFiltro: TPanel
    Left = 280
    Top = 202
    Width = 219
    Height = 153
    ...
    object dblcXX: TwwDBLookupCombo
      Left = 66
      Top = 72
      Width = 121
      Height = 21
      ...
      Selected.Strings = (
        'ZIPID'#9'3'#9'Id'#9'F'
        'ZIPDES'#9'35'#9'Codigo Postal'#9'F')
    ...
    object dbdtpXX: TwwDBDateTimePicker
      Left = 66
      Top = 72
      Width = 121
      Height = 21
    ...
    object dblcdXX: TwwDBLookupComboDlg
      Left = 66
      Top = 72
      Width = 121
      Height = 21
      ...
      Selected.Strings = (
        'TRABID'#9'5'#9'Id'#9'F'
        'TRABNOMT'#9'40'#9'Trabajador'#9'F')
      LookupField = 'TRABID'
      SeqSearchOptions = [ssoEnabled, ssoCaseSensitive]
      TabOrder = 3
      Visible = False
    ...
    object Z2bbtnCancFiltro: TBitBtn
      Left = 120
      Top = 112
      Width = 75
      Height = 25
  ...
  object Z2bbtnFiltros: TBitBtn
    ...
    Glyph.Data = {
      ...
      99999999990000999999999999066099999999999906609999999999990F7099
      99999999990F7099999999999077760999999999067776609999999067F77766
      099999067F77777660999067FFF7777666099000000000000009999999999999
      9999}
  end
  object Z2bbtnConsulta: TBitBtn
    Left = 392
    Top = 1
    Width = 75
    Height = 25
  ...
  object Z2bbtnMant: TBitBtn
    ...
    Caption = 'Cambios'
    TabOrder = 10
    OnClick = Z2bbtnMantClick
  end
  object pnlCambios: TPanel
    Left = 578
    Top = 29
    Width = 103
    Height = 140
