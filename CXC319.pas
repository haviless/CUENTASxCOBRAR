...
Type
   TFToolContabAplica = Class(TForm)
      pnGLT: TPanel;
...
Var
   FToolContabAplica: TFToolContabAplica;

Implementation

Uses CxCDM, oaCC2000, Mant;

{$R *.DFM}

Procedure TFToolContabAplica.Z2bbtnPreviewClick(Sender: TObject);
Var
...
Procedure TFToolContabAplica.Z2bbtnContabClick(Sender: TObject);
Var
   xTMes, xTAno: String;
   a, m, d: word;
Begin
